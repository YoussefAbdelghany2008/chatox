...
function SignPage({children}) {
    return (
        <main className="grid grid-cols-7  bg-blue-500 h-screen w-screen signPage max-md:bg-white">
            <div className="right bg-white border-r-indigo-200 rounded-r-lg center col-span-4 max-md:col-span-7">
                <div className='grid gap-4 p-6'>
                    ...
                    <div className="grid gap-x-4 h-12 grid-cols-2">
                        <button className="center size-full bg-white shadow-md text-sm border rounded-md text-gray-800 dark:bg-gray-900 border-gray-300  font-medium dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        ...
                        <button className="center size-full bg-blue-500 shadow-md text-sm border rounded-md space-x-3 text-white transition-colors duration-200 transform  dark:text-gray-300 dark:border-gray-300 hover:bg-gray-600 dark:hover:bg-gray-700  focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 ">
